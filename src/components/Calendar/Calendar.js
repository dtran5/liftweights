...
const Calendar = (props) => {
    ...
    return (
      <div className="calendar__header row">
        <div className="column col-start">
          <div className="calendar__icon" onClick={prevMonth}>
            chevron_left
          </div>
        </div>
        ...
        <div className="column col-end">
          <div className="calendar__icon" onClick={nextMonth}>
            chevron_right
          </div>
        </div>
      </div>
  ...
  const cells = () => {
    ...
    while (day <= endDate) {
        ...
        if (trainerTypeState) {
          days.push(
            <Link
              ...
              className={`calendar__column calendar__cell ${
      ...
      rows.push(
        <div className="calendar__row row" key={day}>
          {days}
        </div>
      );
      days = [];
